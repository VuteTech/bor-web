---
title: "Bor v0.8.0 released"
author: "Blagovest Petrov"
author_url: "https://vute.tech"
date: 2026-08-02T00:00:00+03:00
tags: ["release", "thunderbird", "edge", "firewalld", "security"]
---

Bor v0.8.0 is out. This release adds three new policy types — **Thunderbird**, **Microsoft Edge for Business**, and **Firewalld zones** — alongside a full web UI overhaul, finer-grained RBAC, and a dedicated security hardening pass. The complete changelog is on the [GitHub release page](https://github.com/VuteTech/bor/releases/tag/v0.8.0).

![The Policies list in v0.8.0 — Thunderbird, Edge, and Firewalld join Firefox, Chrome, Package, and dconf](/images/screenshots/policies-list.png)
...
![Thunderbird policy in the tree editor — privacy, security, add-ons, and more](/images/screenshots/policy-thunderbird.png)
...
![Microsoft Edge policy — a released kiosk baseline in the read-only Configuration view](/images/screenshots/policy-edge.png)
...
![Firewalld zone policy — target zone, allowed services, and ports](/images/screenshots/policy-firewalld.png)
...
![Polkit rule with an action.lookup() variable condition — drive_removable == true](/images/screenshots/policy-polkit.png)
...
![The redesigned dashboard with drill-down stat tiles and grouped sidebar navigation](/images/screenshots/dashboard.png)
...
![The full-page policy editor](/images/screenshots/policy-editor.png)

Node and compliance lists are paginated, filtered, and sorted server-side, so fleets with thousands of nodes stay fast:

![The Nodes list with server-side pagination and searchable filter dropdowns](/images/screenshots/nodes.png)
...
![The password step of the redesigned two-step login — reveal toggle and live Caps Lock warning](/images/screenshots/login-password-reveal.png)
...
![Audit logs — every login, policy change, and admin action, exportable as injection-safe CSV or JSON](/images/screenshots/audit-logs.png)
